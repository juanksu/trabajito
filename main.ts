...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Huevo, function (sprite, otherSprite) {
    info.changeScoreBy(10)
    Pato_chiquito.setPosition(randint(0, 100), randint(100, 10))
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite, otherSprite) {
    game.over(false)
})
let Pato_chiquito: Sprite = null
info.setScore(0)
let Lai = sprites.create(img`
    . . . . . f f 4 4 f f . . . . . 
    . . . . f 5 4 5 5 4 5 f . . . . 
    . . . f e 4 5 5 5 5 4 e f . . . 
    ...
    . . . . . f f b b f f . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(Lai, 100, 100)
let Qui = sprites.create(img`
    . . . . . . . . . . . . . . 
    e e e . . . . e e e . . . . 
    c d d c . . c d d c . . . . 
    c b d d f f d d b c . . . . 
    ...
    . . . f f f f f f . . . . . 
    `, SpriteKind.Enemy)
Pato_chiquito = sprites.create(img`
    ...bbbbbbbbb.........
    ..bbb111111bbbb......
    .bb11111111111bbb....
    bb1111111111111dbb...
    bb111111155111111bb..
    bd555111155111111dbb.
    cb555511111111111ddb.
    cb555511111111555ddbb
    cbb55511111115555bd5b
    cbb55511111115555bd5b
    cdbb551111111555bb55b
    ccdbb1111111115bbbddc
    .c5dddd1111111dbbdddc
    .c5dddddddddddddddddc
    ...
    ......cccccccccc.....
    `, SpriteKind.Huevo)
Lai.setPosition(10, 11)
Qui.setPosition(142, 120)
game.onUpdate(function () {
    Qui.setVelocity(1, 5)
})
game.onUpdateInterval(5000, function () {
    Pato_chiquito.setPosition(randint(0, 100), randint(100, 100))
})
forever(function () {
